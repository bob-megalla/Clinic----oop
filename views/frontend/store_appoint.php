      ...
      <div class="container">
        ...
        <div class="d-flex flex-column gap-3 details-card doctor-details">
          <div class="details d-flex gap-2 align-items-center">
            <img
              src="assets/img/doctors/<?= $allDoctors[0]['img_doctor']?>"
              alt="doctor"
            ...
            <div class="details-info d-flex flex-column gap-3">
              <h4 class="card-title fw-bold"><?= strtoupper($allDoctors[0]['name_doctor'])?></h4>
              <h6 class="card-title fw-bold">
                Doctor <?= strtoupper($allDoctors[0]['name_doctor'])?> Works in Major <?= strtoupper($allDoctors[0]['name_major'])?> and more info about the doctor in summary
